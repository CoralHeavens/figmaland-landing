...
export default function TopSection() {
    return (
        <section className="w-full flex flex-col items-center pt-[206px] lg:pt-[110px] px-5 pr-10">
            ...
            <div className="mx-12 mr-10 mt-[27px] text-white text-[28px] leading-[40px] text-center font-normal tracking-[0.2px]">
                {subTitle.top}<br/>{subTitle.bottom}
            </div>
            <Button label={linkLabel} className='-mr-4' />
        </section>
    )
}